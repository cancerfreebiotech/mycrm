...
const SELECT_FIELDS = 'id, name, company, job_title, email, phone, country_code, met_at, created_at, last_activity_at, importance, language, email_status, created_by, users!created_by(display_name), contact_tags(tags(id, name))'
